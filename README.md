...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 5d431052-1fbb-4e81-a82d-841eeb08d3a6
```

> `5d431052-1fbb-4e81-a82d-841eeb08d3a6` is the password of the certificate, you can change it to any password you want.
